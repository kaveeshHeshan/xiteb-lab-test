...
<section class="dashboard-body">
    ...
    <div class="dashboard-inner-content shadow">
        ...
        <div class="-section">
            ...
            <hr>
            <div class="">
                <form id="category_store_form" method="POST" action="{{route('categories.store')}}" enctype="multipart/form-data">
                    @csrf
                    <!-- Profile -->
                    <div class="">
                        {{-- <form> --}}
...
<script>
    ...
    {!! JsValidator::formRequest('App\Http\Requests\StoreCategoryRequest', '#category_store_form'); !!}
@endpush
