...
<section class="dashboard-body">
    ...
    <div class="dashboard-inner-content shadow">
        ...
        <div class="-section">
            ...
            <hr>
            <div class="">
                <form id="category_update_form" method="POST" action="{{route('categories.update', $category->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <!-- Profile -->
                    <div class="">
                        {{-- <form> --}}
                            ...
                            <div class="row form-section">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="post-title" class="form-control" name="name" placeholder="Category Title" value="{{$category->name}}">
                                </div>
                            </div>
                            ...
                            <div class="row form-section mt-3">
                                ...
                                <div class="col-md-4 text-center">
                                    ...
                                    <img id="selected-category-img" class="rounded-circle" style="background: #fff; width: 120px; height: 90px; object-fit: cover; border-radius: 10px !important;" src="{{ asset('/storage/category/'.$category->image) ?? asset('/img/system_default/default-image-placeholder.jpg') }}" alt="">
                                </div>
...
<script>
    ...
    {!! JsValidator::formRequest('App\Http\Requests\UpdateCategoryRequest', '#category_update_form'); !!}
@endpush
