                        ...
                        {{-- <form> --}}
                            ...
                            <div class="row form-section">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="post-title" class="form-control" name="name" placeholder="Subcategory Title" value="{{$subcategory->name}}">
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row form-section mt-3">
                                <div class="col-md-4">
                                    ...
                                    <input id="category-img-input" class="form-control" type="file" name="subcategory_cover_image">
                                </div>
                                <div class="col-md-4 text-center">
                                    <label for="selected-category-img">{{__('Selected Image')}}</label>&nbsp;
                                    <img id="selected-category-img" class="rounded-circle" style="background: #fff; width: 120px; height: 90px; object-fit: cover; border-radius: 10px !important;" src="{{ asset('/storage/subcategory/'.$subcategory->image) ?? asset('/img/system_default/default-image-placeholder.jpg') }}" alt="">
                                </div>
                                <div class="col-md-4"></div>
                            </div>
                            <div class="row form-section mt-1" style="padding-left: 15px;">
                                <div class="col-md-4 form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="is_active" @if ($subcategory->is_active == 1) checked @endif>
...
<script>
    ...
    {!! JsValidator::formRequest('App\Http\Requests\UpdateSubcategoryRequest', '#subcategory_update_form'); !!}
@endpush
