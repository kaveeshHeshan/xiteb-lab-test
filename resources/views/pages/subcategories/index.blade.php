    ...
    <div class="dashboard-inner-content shadow">
        ...
        <div class="table-section">
            <div class="section-heading " style="display: flex;justify-content: space-between;">
                <div class="">
                    <h2>{{__('Subcategories Management')}}</h2>
                </div>
                @can('subcategory.create')
                    <div class="" style="">
                        <a href="{{url('/subcategories/create')}}" class="btn btn-primary float-right">
                ...
                @if (count($subcategories) > 0)
                    <div class="table mb-4">
                        <div class="table-responsive">
                            <table id="subcategory-table" class="table align-items-center table-flush booking_table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($subcategories as $subcategory)
                                            <tr>
                                                <td class="">{{$i}}</td>
                                                <td class="">
                                                    <img class="rounded" style="background: transparent; width: 80px; height: 50px; object-fit: cover;" src="{{ $subcategory->subcategoryImage() }}" alt="">
                                                </td>
                                                <td>{{$subcategory->name ?? '--'}}</td>
                                                <td>{{$subcategory->created_at->format('Y-M-d H:m A') ?? '--'}}</td>
                                                <td class="text-right">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            @can('subcategory.edit')
                                                                <a class="dropdown-item"
                                                                    href="{{ url('/subcategories', $subcategory->id) }}/edit">
