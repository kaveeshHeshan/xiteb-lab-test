    ...
    <div class="dashboard-inner-content shadow">
        ...
        <div class="table-section">
            <div class="section-heading " style="display: flex;justify-content: space-between;">
                <div class="">
                    <h2>{{__('Posts Management')}}</h2>
                </div>
                <div class="" style="">
                    <a href="{{url('/posts/create')}}" class="btn btn-primary float-right">
                                ...
                                <tbody>
                                    ...
                                    {{-- @foreach ($posts as $post)
                                            <tr>
                                                ...
                                                <td>{{$post->title ?? '--'}}</td>
                                                <td>{{$post->createdUserData->name ?? '--'}}</td>
                                                <td>{{$post->created_at->format('Y-M-d H:m A') ?? '--'}}</td>
                                                <td class="text-right">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <button type="button" class="dropdown-item text-danger" onclick="postRemove( event, {{$post->id}})">
